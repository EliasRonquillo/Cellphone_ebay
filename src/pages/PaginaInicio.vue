    ...
    <div class="row">
      <div class="col-2">
        ...
        <fieldset>
          <legend>Marca</legend>
          <div class="q-pr-xl">
            <q-checkbox val="secondary" label="Samsung (40)" color="secondary" />
        ...
        <fieldset>
          ...
          <div class="q-pr-xl">
            <q-checkbox val="secondary" label="Android (40)" color="secondary" />
            <q-checkbox val="secondary" label="Windows (40)" color="secondary" />
      ...
      <q-dialog v-model="prompt" persistent :maximized="maximizedToggle" transition-show="slide-up"
        transition-hide="slide-down">
        <q-card class="ventanaemergente">
              ...
              <div class="col-md-6 col-12">
                ...
                <fieldset style="border: 2px solid #000000">
                  ...
                  <div class="q-gutter-sm">
                    ...
                    <div class="input-group">
                      <label>Marca:</label>
                      <q-select label="" transition-show="scale" transition-hide="scale" filled v-model="selectedOption"
                        :options="options" style="width: 200px; border: 2px solid #00000098 ;"
              ...
              <div class="col-md-6 col-12">
                ...
                <fieldset>
                  ...
                  <div class="q-gutter-sm">
                    ...
                    <q-input v-model="descripcion" label="" outlined dense @keyup.enter="prompt = false" type="textarea"
                      style=" border: 2px solid #00000098 ;" />

                    <fieldset style="width: 110px; margin: 0 auto; text-align: center; border: 2px solid #00000098;  ">
